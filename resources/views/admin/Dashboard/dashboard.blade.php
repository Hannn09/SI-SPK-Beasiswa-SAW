...
<div class="group-card d-flex gap-3">
    ...
    <div class="card w-25 border-0 px-3 py-2 rounded-4 shadow">
        <div class="header-icon d-flex justify-content-between align-items-center">
            ...
            <div class="menu-detail">
                <a href="{{ route('data.mhs') }}" class="text-decoration-none text-black dropdown" data-bs-toggle="dropdown"
                    aria-expanded="false">
        ...
        <div class="content-card mt-2">
            <div class="total-students">
                <span class="fw-bold fs-2">{{ $mahasiswaCount }}</span>
            </div>  
    ...
    <div class="card w-25 border-0 px-3 py-2 rounded-4 shadow">
        ...
        <div class="content-card mt-2">
            <div class="total-students">
                <span class="fw-bold fs-2">{{ $ortuCount }}</span>
            </div>
    ...
    <div class="card w-25 border-0 px-3 py-2 rounded-4 shadow">
        ...
        <div class="content-card mt-2">
            <div class="total-students">
                <span class="fw-bold fs-2">{{ $fileCount }}</span>
            </div>
    ...
    <div class="card w-25 border-0 px-3 py-2 rounded-4 shadow">
        ...
        <div class="content-card mt-2">
            <div class="total-students">
                <span class="fw-bold fs-2">{{ $alternatifCount }}</span>
            </div>
