...
@section('content')
    <div class="content-form">
        <h4 class="fw-semibold mb-4">Form Data Kriteria Pendapatan</h4>
        {{-- Form --}}
        <div class="form-add p-4 bg-white rounded-4">
            <form action="{{ route('pendapatan-store') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control input @error('sub_kriteria') is-invalid @enderror"
                        id="sub_kriteria" placeholder="Masukkan Sub Kriteria Pendapatan" name="sub_kriteria">
                    @error('sub_kriteria')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
