    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="d-flex align-items-center justify-content-center gap-3">
                <button class="btn btn-primary px-4" data-bs-toggle="modal" data-bs-target="#target{{ $incomes->id }}">
                    Edit
                </button>
            ...
            <!-- Modal Edit -->
            <div class="modal fade" id="target{{ $incomes->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <form action="{{ route('pendapatan-update',['id' => $incomes->id]) }}" method="post">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ $incomes->nilai_sub_kriteria }}">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('pendapatan-delete', ['id' => $incomes->id]) }}" method="delete">
                                @csrf
